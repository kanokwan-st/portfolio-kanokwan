...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0E100F] text-[#FEFBE0]">
      ...
      {/* SECTION 1 */}
      <section id="home" className="flex flex-col justify-between w-full h-screen px-32">
        <article className="flex w-full h-[70%]">
          <div className="flex flex-col justify-center w-[60%] h-full">
            ...
            <div className='relative'>
              ...
              {/* reserve space */}
              <h2 className="pt-10 invisible text-2xl font-bold">I love logical thinking and planning.</h2>
            </div>
          </div>
        ...
        <div className='h-[27%]'>
          <div className="flex justify-center gap-8">
            <Button as='a' href="#project" className='px-15'>My Projects</Button>
            <Button as='a' href="#experience" className='px-15'>Experience</Button>
          </div>

        </div>
      </section>
      <hr className="mb-6 h-[0.5px] w-[90%] bg-[#3B3C37] border-none mx-auto" />

      {/* SECTION 2 */}
      <section ref={aboutRef} id="about" className="opacity-0 translate-y-10 scale-95 flex flex-col justify-center items-center px-64 py-25 w-full bg-[#2a1438]">
        <h2 className="text-2xl font-bold pb-10">Know Me More</h2>
        <div className='border-2 p-10 rounded-2xl bg-[#1E0F2F] shadow-2xl hover:scale-101 transition-all duration-300 will-change-transform'>
      ...
      {/* SECTION 3 */}
      <section id="experience" className="flex flex-col justify-center items-center px-32 py-15 w-full ">
        <h2 className="text-2xl font-bold pb-8">Experience</h2>
        <Button as="a" href="/files/CV-Kanokwan.pdf" download>Download CV</Button>
        <div ref={experienceRef} className="opacity-0 translate-y-10 scale-95 flex flex-col pt-10">
          {/* Exp1 */}
      ...
      {/* SECTION 4 */}
      <section id="skills" className="flex flex-col justify-center items-center lg:px-50 xl:px-80 py-20 w-full bg-[#2a1438]">
        <h2 className="flex items-center justify-center pb-12 w-full h-10 text-2xl font-bold">
          Skill Set
        </h2>
        <div ref={skillBoxRef} className="opacity-0 translate-y-10 scale-95 w-full flex border-2 rounded">
          {/* BOX 1 */}
      ...
      {/* SECTION 5 */}
      <section ref={projectRef} id="project" className="opacity-0 translate-y-10 scale-95 flex flex-col justify-center items-center px-32 py-10 w-full h-100">
        <h2 className="flex items-center justify-center pb-12 w-full h-10 text-2xl font-bold">
          My Project
        </h2>
        <article className="flex gap-4 w-full h-full">
          <figure className="flex items-center justify-center w-[50%] h-full bg-[#9557eb92] rounded-2xl">
            <img
          ...
          <div className="flex flex-col p-12 w-[50%] h-full bg-gray-700 rounded-2xl">
      ...
      {/* SECTION 6 */}
      <section id="miniproject" className="hidden flex flex-col justify-center items-center px-32 w-full h-100 bg-[#2a1438]">
      ...
      <section id="contact" className="flex flex-col justify-center items-center px-32  w-full h-50">
        ...
        <div className="flex gap-3">
          ...
          <a href="mailto:kanokwan.stae@gmail.com" target="_blank">
